	...
	class actionConfirm implements ActionListener {
		public void actionPerformed(ActionEvent arg0){
			...
			if(BT){
				...
				JOptionPane Validation = new JOptionPane();
				Validation.showMessageDialog(null,"Billet de train valide","Billet n° "+newBillet.getNumero().toString(),JOptionPane.DEFAULT_OPTION);
				...
				JOptionPane Validation = new JOptionPane();
				Validation.showMessageDialog(null,"Billet de bus valide","Billet n° "+newBillet.getNumero().toString(),JOptionPane.DEFAULT_OPTION);
